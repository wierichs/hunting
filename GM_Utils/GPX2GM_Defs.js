...
JB.Icons = function(baseurl) {
	...
	this["boat ramp"]   = { icon:   { anchor: {x:15,y:36}, url: baseurl+"Icons/boat.png" },
											shadow: { anchor: {x:10,y:31}, url: baseurl+"Icons/shadow.png" } };
	this.hunter       = { icon:   { anchor: {x:15,y:36}, url: baseurl+"../Icons/hunter.png" },
	                    shadow: { anchor: {x:10,y:31}, url: baseurl+"Icons/shadow.png" } };
	this.ladder       = { icon:   { anchor: {x:15,y:36}, url: baseurl+"../Icons/ladder.png" },
	                    shadow: { anchor: {x:10,y:31}, url: baseurl+"Icons/shadow.png" } };
	this.sleepingtrailer       = { icon:   { anchor: {x:15,y:36}, url: baseurl+"../Icons/sleepingtrailer.png" },
	                    shadow: { anchor: {x:10,y:31}, url: baseurl+"Icons/shadow.png" } };
	this.trailer       = { icon:   { anchor: {x:15,y:36}, url: baseurl+"../Icons/trailer.png" },
	                    shadow: { anchor: {x:10,y:31}, url: baseurl+"Icons/shadow.png" } };
	this.hotel       = { icon:   { anchor: {x:15,y:36}, url: baseurl+"../Icons/hotel.png" },
	                    shadow: { anchor: {x:10,y:31}, url: baseurl+"Icons/shadow.png" } };
	this.booth       = { icon:   { anchor: {x:15,y:36}, url: baseurl+"../Icons/booth.png" },
	                    shadow: { anchor: {x:10,y:31}, url: baseurl+"Icons/shadow.png" } };
