...
( function() {
	...
	show_style.create();
	show_style.add(".JB_Photo","position:fixed; display: flex; align-items: center; top:0; left:0; width:100%; height:100%; height:100vh; margin:0; background-color:rgba(0,0,0,0.0); font-size:0.1em; z-index:1000; transition: all 0.5s; -webkit-transition: all 0.5s ");
